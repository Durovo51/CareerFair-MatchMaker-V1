...
+ "\n\nSTEP 4: RESUME QUALITY GATE\nBefore producing output, evaluate whether the resume itself is usable. Treat the resume as unusable "
+ "if it is severely incomplete, contains no real skills/experience/education, is mostly placeholder or filler text, is unrelated to "
+ "employment (e.g. random text, gibberish, or an unrelated document), or otherwise gives you nothing substantive to match against the "
+ "COMPANY DATA. If the resume is unusable, OR if zero companies survive Step 2's elimination criteria, do not list any companies. "
+ "Instead, output exactly this single line and nothing else: \"You don't have any matches at this career fair.\"\n\nOUTPUT FORMAT:\n"
